...
Middleware acts like a sort of assembly line, doing operations on the request, and optionally halting to send a response, or do some other action like logging, along the way.

- [X] Describe a Resource?

Anything you want to see or know about is a resource. I want all of the "players" on the team, all of the "flavors" of ice cream, resources.
...
By separating our routes out into individual files much like react components.
